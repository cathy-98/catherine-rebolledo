...
export function About() {
  return (
    <section id="quien-soy" className="about-figma-section">
      <Image className="about-doodle about-doodle-sun" src="/figma/hero-sun.svg" alt="" width={81} height={87} />
      <Image className="about-doodle about-doodle-heart" src="/figma/hero-heart.svg" alt="" width={63} height={52} />
      <Image className="about-doodle about-doodle-flower" src="/figma/hero-flower.svg" alt="" width={52} height={44} />
